...
campusproxy_on() {
  sudo easytier-core -c "$HOME/Library/Mobile Documents/iCloud~com~nssurge~inc/Documents/easytier.toml"
}

# download model
alias download="python $HOME/Documents/coding/ConductingExp/util/download_model.py"
